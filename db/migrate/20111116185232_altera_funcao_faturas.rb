class AlteraFuncaoFaturas < ActiveRecord::Migration
  def self.up
...
"
  ...
  def self.down
     execute "              create or replace function fnc_gerar_faturas(pinicio date, pfim date, puf varchar, pvencimento date) returns setof tp_conf_faturas_res as
$$
  declare
     vcartorios record;
     vreg record;
