...
#   inflect.singular /^(ox)en/i, '\1'
    ...
    inflect.irregular 'repasse_fabrica', 'repasses_fabrica'
    inflect.irregular 'tipo_de_notificacao', 'tipos_de_notificacao'
    inflect.irregular 'modelo_de_notificacao','modelos_de_notificacao'
